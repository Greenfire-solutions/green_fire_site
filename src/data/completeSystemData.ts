...
export const tenStageSystem: SystemStage[] = [
  ...
  },
  {
    ...
    title: 'Council',
    whatHappens:
      'Community input is reviewed, clarified, and prioritized — with Indigenous Elder guidance invited on values, morals, and cultural context when relationships and consent allow — to determine an appropriate next step.',
    whoParticipates: ['Community members', 'Indigenous Elders (when invited)', 'Project stewards', 'Facilitators'],
  ...
  },
  {
    ...
    title: 'Design',
    whatHappens:
      'Interdisciplinary teams shape the smallest useful version of a project safe enough to test, informed by Elder guidance, community wisdom, and bioregional context.',
    whoParticipates: ['Youth', 'Makers', 'Artists', 'Researchers', 'Community liaisons', 'Indigenous Elders (when invited)'],
  ...
  },
  {
    ...
    whatHappens:
      'Media documents the need, process, and outcomes with consent — including Elder review of sensitive stories — making work visible and fundable on terms knowledge holders approve.',
    whoParticipates: [
      'Filmmakers',
      'Photographers',
      'Podcast producers',
      ...
      'Indigenous Elders (when invited to review or guide)',
    ],
