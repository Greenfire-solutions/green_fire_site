...
export function ElderGuidanceSection() {
  ...
  return (
    <section className="border-b border-white/5 py-20 px-6 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <SectionTitle title={elderGuidance.headline} />
        <p className="text-stone-300 leading-relaxed max-w-3xl mb-6 text-lg">{elderGuidance.subheadline}</p>
