    ...
    <div className="min-h-screen bg-neutral-950 text-stone-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-100 pb-10">
          ...
          <div className="grid gap-12 py-24 md:grid-cols-[1.2fr_0.8fr] md:items-center relative z-10">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                <button className="inline-flex items-center justify-center rounded-2xl bg-emerald-400 px-8 py-4 text-base font-semibold text-neutral-950 transition-all hover:bg-emerald-300 shadow-[0_0_20px_rgba(52,211,153,0.2)]">
      ...
      <section className="border-y border-emerald-900/40 bg-neutral-950 py-32 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center z-10">
          ...
          <button className="inline-flex items-center justify-center rounded-2xl bg-emerald-400 px-10 py-5 text-lg font-bold text-neutral-950 transition-all hover:bg-emerald-300 hover:scale-105 shadow-[0_0_30px_rgba(52,211,153,0.2)]">
...
function InnovationMap({ navigate }) {
      ...
      <section className="relative pt-24 pb-20 px-6 border-b border-emerald-900/30 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="rounded-xl bg-emerald-400 px-8 py-4 text-sm font-bold text-neutral-950 hover:bg-emerald-300 transition-colors shadow-[0_0_20px_rgba(52,211,153,0.2)]">Submit a Need</button>
            <button className="rounded-xl border border-white/10 bg-white/5 px-8 py-4 text-sm font-bold text-white hover:bg-white/10 transition-colors">Join Founding Circle</button>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="rounded-3xl border border-white/10 bg-neutral-950 p-8 shadow-2xl relative">
              ...
              <div className="space-y-4 opacity-80 pointer-events-none">
                ...
                <button className="w-full h-12 rounded-xl bg-blue-500/20 text-blue-400 font-bold mt-2 border border-blue-500/30">Submit Need</button>
              </div>
              ...
              >
                <div className="pt-8 border-t border-white/10 space-y-24 pb-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {[
                        ...
                        <div key={quest.title} className="rounded-[2rem] border border-white/10 bg-neutral-900/50 p-8 shadow-xl backdrop-blur-sm flex flex-col hover:border-emerald-500/30 transition-colors">
                          ...
                          <button className="w-full py-4 rounded-xl bg-neutral-800 text-white text-sm font-bold hover:bg-emerald-400 hover:text-neutral-950 transition-all border border-white/5 flex items-center justify-center gap-2 group shadow-lg">
                  ...
                  <div className="text-center max-w-3xl mx-auto pt-12">
                    ...
                    <button className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-400 px-10 py-5 text-lg font-bold text-neutral-950 shadow-[0_0_20px_rgba(52,211,153,0.2)] hover:bg-emerald-300 transition-all hover:scale-105">
      ...
      <section className="py-32 px-6 border-t border-emerald-900/40 bg-neutral-950 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
             <button className="rounded-2xl bg-orange-400 px-8 py-4 text-sm font-bold text-neutral-950 hover:bg-orange-300 transition-colors shadow-[0_0_20px_rgba(251,146,60,0.2)]">Donate to Pilot</button>
             <button className="rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-sm font-bold text-white hover:bg-white/10 transition-colors">Become a Founder</button>
             <button className="rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-sm font-bold text-white hover:bg-white/10 transition-colors">Offer a Workshop</button>
             <button className="rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-sm font-bold text-white hover:bg-white/10 transition-colors">Submit a Need</button>
          </div>
